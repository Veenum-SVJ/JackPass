...
```html
<table width="100%" cellpadding="0" cellspacing="0" style="background-color:#0E0B1F; padding:40px 0; font-family:'Plus Jakarta Sans',Arial,sans-serif;">
  <tr>
    <td align="center">
      <table width="480" cellpadding="0" cellspacing="0" style="background-color:#1A1730; border-radius:16px; overflow:hidden; border:1px solid rgba(91,75,224,0.2);">
        <!-- Header -->
        <tr>
