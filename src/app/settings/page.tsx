                ...
                return (
                     <Card>
                        ...
                        <CardContent className="space-y-2">
                           <Link href="/support#faq" className="flex items-center justify-between p-4 border rounded-lg hover:bg-muted/50"><span>Frequently Asked Questions</span><ChevronRight/></Link>
                           <Link href="/support" className="flex items-center justify-between p-4 border rounded-lg hover:bg-muted/50"><span>Contact Support</span><ChevronRight/></Link>
                           <Link href="#" className="flex items-center justify-between p-4 border rounded-lg hover:bg-muted/50"><span>Terms & Conditions</span><ChevronRight/></Link>
                           <Link href="#" className="flex items-center justify-between p-4 border rounded-lg hover:bg-muted/50"><span>Privacy Policy</span><ChevronRight/></Link>
                        </CardContent>
                    </Card>
                );
            default:
