...
export default function SupportPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto pb-24">
      ...
      <section className="mb-12 px-4">
        <div className="relative overflow-hidden p-6 bg-primary/5 border border-primary/20 rounded-lg text-center">
          <div aria-hidden className="absolute inset-0 bg-adire text-primary/10" />
          <div className="relative">
            ...
            <Button asChild variant="outline">
              <Link to="/community">Ask in the Community Forum <ArrowRight className="ml-2 h-4 w-4" /></Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="px-4">
        ...
        <div className="bg-card p-6 border rounded-lg shadow-lg">
          <Form {...form}>
